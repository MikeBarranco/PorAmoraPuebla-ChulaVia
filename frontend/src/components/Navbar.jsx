              ...
              <li key={to}>
                <Link
                  ...
                  style={{
                    ...
                    borderBottom: active ? '2px solid #C1440E' : '2px solid transparent',
          ...
          <li style={{ marginLeft: '12px' }}>
            <Link
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 4px 14px rgba(193,68,14,0.5)'
                e.currentTarget.style.transform = 'translateY(-1px)'
              }}
              onMouseLeave={e => {
                e.currentTarget.style.backgroundColor = '#C1440E'
                e.currentTarget.style.boxShadow = '0 2px 8px rgba(193,68,14,0.35)'
